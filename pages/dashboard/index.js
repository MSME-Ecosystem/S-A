                ...
                <div className="card-header border-0 flex-wrap pb-0">
                  ...
                  <div className="d-flex flex-wrap mb-2">
                    <div className="form-check me-4 mb-2">
                      ...
                      >
                        <span className="d-block  font-w500">BTS</span>
                      </label>
                    </div>
                    <div className="form-check me-4 mb-2">
                      <input
                      ...
                      >
                        <span className="d-block  font-w500">XRP</span>
                      </label>
                    </div>
                    <div className="form-check me-4 mb-2">
                      <input
                      ...
                      >
                        <span className="d-block  font-w500">ETH</span>
                      </label>
                    </div>
                    <div className="form-check me-4 mb-2">
                      <input
                      ...
                      >
                        <span className="d-block  font-w500">ZEC</span>
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="card">
                    ...
                    <div className="card-body p-3 pb-0 sell-order">
                      <select className="form-control custom-image-select-2 image-select mt-3 mt-sm-0">
                        <option data-thumbnail="/dashboard/images/svg/lit3.svg">
                          Litecoin
                        </option>
                        <option data-thumbnail="/dashboard/images/svg/btc.svg">
                          Ripple
                        </option>
                        <option data-thumbnail="/dashboard/images/svg/eth.svg">
                          Ethereum
                        </option>
                        <option data-thumbnail="/dashboard/images/svg/btc.svg">
                          Bitcoin
                ...
                <div className="col-sm-6">
                  <div className="card">
                    ...
                    <div className="card-body p-3 pb-0">
                      <select className="form-control custom-image-select-2 image-select mt-3 mt-sm-0">
                        <option data-thumbnail="/dashboard/images/svg/monero.svg">
                          Monero
                        </option>
                        <option data-thumbnail="/dashboard/images/svg/eth.svg">
                          Ethereum
                        ...
                        <option data-thumbnail="/dashboard/images/svg/ltc.svg">
                          Litecoin
                        </option>
                      </select>
                      <div className="table-responsive">
              ...
              <div className="row">
                <div className="col-sm-6">
                  <div className="card-bx stacked card">
                    <img src="/dashboard/images/card/card1.jpg" alt="" />
                ...
                <div className="col-sm-6">
                  <div className="card-bx stacked card">
                    <img src="/dashboard/images/card/card2.jpg" alt="" />
                    <div className="card-info">
                ...
                <div className="col-sm-6">
                  <div className="card-bx stacked card">
                    <img src="/dashboard/images/card/card3.jpg" alt="" />
                    <div className="card-info">
                      <p className="mb-1 text-white fs-14">Main Balance</p>
                      <div className="d-flex justify-content-between">
                        <h2 className="num-text text-white mb-5 font-w600">
                ...
                <div className="col-sm-6">
                  <div className="card-bx stacked card">
                    <img src="/dashboard/images/card/card4.jpg" alt="" />
                    <div className="card-info">
                      <p className="mb-1 text-white fs-14">Main Balance</p>
                      <div className="d-flex justify-content-between">
                        <h2 className="num-text text-white mb-5 font-w600">
                    ...
                    <div className="card-body">
                      ...
                      <div className="testimonial-one px-4 owl-right-nav owl-carousel owl-loaded owl-drag">
                        <div className="items">
                          <div className="text-center">
                            <img
                              ...
                              src="dashboard/images/contacts/Untitled-1.jpg"
                              alt=""
                            />
                            <h5 className="mb-0">
                              <a
                        ...
                        <div className="items">
                          <div className="text-center">
                            <img
                              className="mb-3 rounded"
                              src="/dashboard/images/contacts/Untitled-2.jpg"
                              alt=""
                            />
                            <h5 className="mb-0">
                              <a
                        ...
                        <div className="items">
                          <div className="text-center">
                            <img
                              className="mb-3 rounded"
                              src="/dashboard/images/contacts/Untitled-3.jpg"
                              alt=""
                            />
                            <h5 className="mb-0">
                              <a
                        ...
                        <div className="items">
                          <div className="text-center">
                            <img
                              className="mb-3 rounded"
                              src="/dashboard/images/contacts/Untitled-4.jpg"
                              alt=""
                            />
                            <h5 className="mb-0">
                              <a
                        ...
                        <div className="items">
                          <div className="text-center">
                            <img
                              className="mb-3 rounded"
                              src="/dashboard/images/contacts/Untitled-5.jpg"
                              alt=""
                            />
                            <h5 className="mb-0">
                              <a
                      ...
                      <div className="row pt-sm-5 pt-3 align-items-center">
                        ...
                        <div className="col-sm-6">
                          <a
                            href="javascript:void(0);"
                            className="btn btn-secondary d-block btn-lg"
                          >
                            TRANSFER NOW
                          </a>
                        </div>
